...
readonly class ApproveRevisionHandler
{
    ...
    public function __invoke(ApproveRevisionCommand $command): void
    {
        ...
        DailyRentDetailsValidator::assertValid(
            ...
            dailyBedCount: isset($data['dailyBedCount']) ? (int) $data['dailyBedCount'] : $property->getDailyBedCount(),
        ...
        $property->update(
            ...
            dailyBedCount: isset($data['dailyBedCount']) ? (int) $data['dailyBedCount'] : null,
