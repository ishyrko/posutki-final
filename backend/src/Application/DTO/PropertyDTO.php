...
final class PropertyDTO implements \JsonSerializable
{
    public function __construct(
        ...
        /** @var list<array{id:int,name:string,slug:string,category:?string,imageUrl:?string,distanceKm:float}> */
        public readonly array $nearbyLandmarks = [],
    ...
    public function jsonSerialize(): array
    {
        ...
        if ($this->freeLimitBlockIntro !== null) {
            $data['freeLimitBlockIntro'] = $this->freeLimitBlockIntro;
        }
