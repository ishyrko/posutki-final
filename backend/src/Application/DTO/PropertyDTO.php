...
final class PropertyDTO implements \JsonSerializable
{
    public function __construct(
        ...
        public readonly string $placementType = 'free',
        public readonly ?int $placementSlotRank = null,
        public readonly ?\DateTimeImmutable $placementExpiresAt = null,
    ...
    public static function fromEntity(
        ...
        return new self(
            ...
            placementType: $property->getPlacementType(),
            placementSlotRank: $property->getPlacementSlotRank(),
            placementExpiresAt: $property->getPlacementExpiresAt(),
    ...
    public function jsonSerialize(): array
    {
        $data = [
            ...
            'placementSlotRank' => $this->placementSlotRank,
            'placementExpiresAt' => $this->placementExpiresAt?->format('c'),
