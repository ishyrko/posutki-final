...
final class PropertyDTO implements \JsonSerializable
{
    public function __construct(
        ...
        public readonly int $placementBaseLevel = 0,
        public readonly int $placementEffectiveLevel = 0,
        public readonly ?\DateTimeImmutable $placementLevelExpiresAt = null,
        public readonly ?\DateTimeImmutable $placementBoostExpiresAt = null,
        public readonly bool $placementIsTrial = false,
        public readonly ?\DateTimeImmutable $freeTrialEndsAt = null,
    ...
    public static function fromEntity(
        ...
        /** @param array{name: ?string, phone: ?string, phones: list<array{phone: string, hasViber: bool, hasWhatsapp: bool}>, telegram: ?string, hasEmail?: bool}|null $ownerContact */
        ...
        $ownerContact ??= ['phone' => null, 'name' => null, 'phones' => [], 'telegram' => null, 'hasEmail' => false];
        ...
        return new self(
            ...
            placementBaseLevel: $property->getPlacementBaseLevel(),
            placementEffectiveLevel: $property->getPlacementEffectiveLevel(),
            placementLevelExpiresAt: $property->getPlacementLevelExpiresAt(),
            placementBoostExpiresAt: $property->getPlacementBoostExpiresAt(),
    ...
    public function jsonSerialize(): array
    {
        $data = [
            ...
            'placementBaseLevel' => $this->placementBaseLevel,
            'placementEffectiveLevel' => $this->placementEffectiveLevel,
            'placementLevelExpiresAt' => $this->placementLevelExpiresAt?->format('c'),
            'placementBoostExpiresAt' => $this->placementBoostExpiresAt?->format('c'),
            'placementIsTrial' => $this->placementIsTrial,
            'freeTrialEndsAt' => $this->freeTrialEndsAt?->format('c'),
