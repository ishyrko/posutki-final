...
#[ORM\Entity]
#[ORM\Table(name: 'city_microdistricts')]
#[ORM\UniqueConstraint(name: 'UNIQ_CITY_MICRODISTRICTS_CITY_OFFICIAL', columns: ['city_id', 'official_name'])]
#[ORM\UniqueConstraint(name: 'UNIQ_CITY_MICRODISTRICTS_CITY_SLUG', columns: ['city_id', 'slug'])]
class CityMicrodistrict
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\Column(type: 'string', length: 255, name: 'name_prepositional')]
    ...
    public function __construct(
        ...
        $this->name = trim($name);
        $this->namePrepositional = trim($namePrepositional);
        $this->slug = $slug;
