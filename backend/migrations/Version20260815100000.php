...
/**
 * Tier-3 VIP placement tariffs for catalog city-prefix slugs that were missing
 * from Version20260729120000 (novolukoml, krichev) plus zhodino.
 */
final class Version20260815100000 extends AbstractMigration
{
    ...
    {
        return 'Upsert tier-3 VIP placement tariffs for zhodino, novolukoml and krichev';
    }
