            ...
            <div className="space-y-4 mb-10">
                ...
                <div className="rounded-xl border border-border bg-card p-5 shadow-card">
                    ...
                    <p className="text-sm text-muted-foreground">
                        ...
                        (или области для усадеб) и указана в таблице цен. На максимальном уровне буст
                        недоступен.
                    </p>
                </div>
                ...
                >
                    ...
                    <p className="text-sm text-muted-foreground">
                        ...
                        каталоге на бесплатном уровне с более низкой позицией. На аккаунте можно бесплатно
                        опубликовать до 5 объявлений (квартиры и усадьбы суммарно). Для квартир действует
                        дополнительный лимит в каждом городе (зависит от числа объявлений в городе).
                        На публичной карточке показываются не более{' '}
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
                ...
                >
                    <TabsList>
                        ...
                        <TabsTrigger value="house">Усадьбы</TabsTrigger>
                    </TabsList>
                </Tabs>
