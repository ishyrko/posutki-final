...
const CARD_CLASS =
  "w-[min(calc(100vw-3.5rem),280px)] shrink-0 snap-start sm:w-[300px] lg:w-[calc((min(100vw,1280px)-5rem)/4)] lg:max-w-[320px]";
  ...
  return (
    <div className="group relative min-w-0 overflow-hidden">
      <button
        ...
        className={`absolute -left-1 top-[42%] z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-card shadow-card transition-opacity hover:border-primary/30 hover:shadow-card-hover sm:-left-3 lg:-left-4 ${
      ...
      <button
        ...
        className={`absolute -right-1 top-[42%] z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-card shadow-card transition-opacity hover:border-primary/30 hover:shadow-card-hover sm:-right-3 lg:-right-4 ${
      ...
      {canScrollLeft && (
        <div className="pointer-events-none absolute inset-y-0 left-0 z-[1] w-8 bg-gradient-to-r from-muted/30 to-transparent" />
      )}
      {canScrollRight && (
        <div className="pointer-events-none absolute inset-y-0 right-0 z-[1] w-8 bg-gradient-to-l from-muted/30 to-transparent" />
      )}
...
export function OwnerOtherListings({ propertyId, ownerName }: OwnerOtherListingsProps) {
  ...
  return (
    <section className="overflow-x-hidden border-t border-border bg-muted/30 py-10 md:py-12">
