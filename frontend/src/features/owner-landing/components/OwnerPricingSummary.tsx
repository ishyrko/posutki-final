...
const PRICING_CARDS = [
    {
        ...
        desc: `Объявление в каталоге без ограничения по времени. На карточке показывается до ${MAX_VISIBLE_PHOTOS_FREE_PLACEMENT} фотографий.`,
    },
    {
            ...
            <div className="container mx-auto px-4">
                <div className="mx-auto max-w-2xl text-center mb-10 md:mb-12">
                    ...
                    <p className="mt-3 text-muted-foreground">
                        Размещение объявления всегда бесплатное. Платное продвижение — по желанию,
                        если нужна более высокая позиция в каталоге.
                    </p>
                </div>
