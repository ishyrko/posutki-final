...
const BENEFITS = [
    ...
    },
    {
        ...
        desc: 'Смотрите, сколько человек просматривает и открывает контакты по каждому объявлению.',
    },
    {
        icon: MessageSquare,
        title: 'Сообщения и заявки',
        desc: 'Заявки на бронирование и сообщения от гостей приходят в единый раздел кабинета.',
    },
    {
        icon: RefreshCw,
