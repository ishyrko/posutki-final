...
sync-landmark-proximity: ## Recalculate landmark proximity for all properties
	...
	docker-compose exec php php bin/console app:sync-landmark-proximity --no-interaction
...
prod-sync-landmark-proximity: ## Recalculate landmark proximity for all properties (production)
	@echo "${GREEN}Recalculating landmark proximity...${RESET}"
	$(PROD_COMPOSE) exec php php bin/console app:sync-landmark-proximity --no-interaction
